                        ...
                        children: [
                          ...
                          const Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Why is this segment risky?',
                                    style: TextStyle(
                                        fontSize: 18,
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              _Pill(label: rainThreshold, color: Colors.black, inverted: true, icon: Icons.water_drop),
              _Pill(label: riskScore, color: riskColor, inverted: true, icon: Icons.warning_amber_rounded),
            ],
          ),
        ],
      ),
...
class _Pill extends StatelessWidget {
  ...
  final bool inverted;
  final IconData? icon;
  const _Pill({required this.label, required this.color, this.inverted = false, this.icon});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          SizedBox(width: 150, child: Text(k, style: const TextStyle(color: Color(0xFF6B7280)))),
