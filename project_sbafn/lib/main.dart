...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'PH Map (MapLibre + Flutter Web)',
...
class _HomePageState extends State<HomePage> {
  ...
  // Public demo style (no API key).
  // You can swap to your own style.json later.
      ...
      body: Stack(
        children: [
          MapLibreMap(
            ...
            // Drop a dot where the user clicks
          ...
          SafeArea(
            child: Padding(
              ...
              child: Container(
                ...
                child: const Text(
                  'Click anywhere to drop a pin · Philippines',
